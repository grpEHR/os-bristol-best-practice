...
This GitHub repo is currently being updated. 

If you wish to update a file, please directly alter the .qmd file (rather than a .html file), and then commit that to your new branch.

The rendered html and output files are generated by the GitHub Actions workflow - you can see this run when opening a PR and when commits are merged/pushed to main. See <https://github.com/grpEHR/os-bristol-best-practice/actions>.
